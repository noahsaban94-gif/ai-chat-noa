...
const STATIC_LOGISTICS_CATALOG = [
  ...
  // --- מק"טים חדשים: מודול זיכרון קשיח, מחירון סגירה וסדר ליקוט מבצעי ---
  // א. מוצרי חצר ומגרש (מחסן 4 החרש — ליקוט: אורן)
  {
    sku: "15109",
    officialName: "דבק קרמיקה 109 כרמית 25 ק״ג",
    category: "דבקים ומליטה",
    defaultWarehouse: "סניף 4 החרש",
    requiresBelaDeposit: false,
    requiresPalletDeposit: true,
    aliases: ["דבק 109", "דבק קרמיקה 109", "כרמית 109", "109 כרמית", "דבק קרמיקה 109 כרמית 25 קג"]
  },
  {
    sku: "114200",
    officialName: "לוח גבס כחול 2.00 מ׳ ע׳ 12.50 מ״מ",
    category: "לוחות גבס ומחיצות",
    defaultWarehouse: "סניף 4 החרש",
    requiresBelaDeposit: false,
    requiresPalletDeposit: false,
    aliases: ["גבס כחול 2 מטר", "לוח גבס כחול 2.00", "לוח כחול 200", "גבס כחול 200"]
  },
  {
    sku: "9570300",
    officialName: "ניצב 0.5 70/300 (מספר 8)",
    category: "פרופילים וקונסטרוקציה לגבס",
    defaultWarehouse: "סניף 4 החרש",
    requiresBelaDeposit: false,
    requiresPalletDeposit: false,
    aliases: ["ניצב 70/300", "ניצב 70", "ניצב 0.5 70", "ניצב מספר 8", "ניצב 8", "9570300"]
  },
  {
    sku: "8570300",
    officialName: "מסלול 0.5 70/300 (מספר 8)",
    category: "פרופילים וקונסטרוקציה לגבס",
    defaultWarehouse: "סניף 4 החרש",
    requiresBelaDeposit: false,
    requiresPalletDeposit: false,
    aliases: ["מסלול 70/300", "מסלול 70", "מסלול 0.5 70", "מסלול מספר 8", "מסלול 8", "8570300"]
  },
  {
    sku: "9550300",
    officialName: "ניצב 0.5 50/300",
    category: "פרופילים וקונסטרוקציה לגבס",
    defaultWarehouse: "סניף 4 החרש",
    requiresBelaDeposit: false,
    requiresPalletDeposit: false,
    aliases: ["ניצב 50/300", "ניצב 50", "ניצב 0.5 50", "9550300"]
  },
  {
    sku: "8550300",
    officialName: "מסלול 0.5 50/300",
    category: "פרופילים וקונסטרוקציה לגבס",
    defaultWarehouse: "סניף 4 החרש",
    requiresBelaDeposit: false,
    requiresPalletDeposit: false,
    aliases: ["מסלול 50/300", "מסלול 50", "מסלול 0.5 50", "8550300"]
  },
  {
    sku: "75300",
    officialName: "ניצב אומגה תקן 300",
    category: "פרופילים וקונסטרוקציה לגבס",
    defaultWarehouse: "סניף 4 החרש",
    requiresBelaDeposit: false,
    requiresPalletDeposit: false,
    aliases: ["אומגה תקן 300", "ניצב אומגה 300", "פרופיל אומגה", "אומגה 3 מטר", "75300"]
  },
  {
    sku: "9876797",
    officialName: "ניצב F47 אורך 3 מטר",
    category: "פרופילים וקונסטרוקציה לגבס",
    defaultWarehouse: "סניף 4 החרש",
    requiresBelaDeposit: false,
    requiresPalletDeposit: false,
    aliases: ["ניצב F47", "פרופיל F47", "F47 3 מטר", "ניצב F-47", "9876797"]
  },
  {
    sku: "9876798",
    officialName: "מסלול F47 אורך 3 מטר",
    category: "פרופילים וקונסטרוקציה לגבס",
    defaultWarehouse: "סניף 4 החרש",
    requiresBelaDeposit: false,
    requiresPalletDeposit: false,
    aliases: ["מסלול F47", "מסלול F-47", "מסלול F47 3 מטר", "9876798"]
  },

  // ב. מוצרי חנות, גמר ופרזול (מחסן 1 התלמיד / דלפק החרש — ליקוט: שי)
  {
    sku: "53009",
    officialName: "סופרקריל לבן 18 ליטר טמבור",
    category: "צבעים וציפויים",
    defaultWarehouse: "סניף 1 התלמיד",
    requiresBelaDeposit: false,
    requiresPalletDeposit: false,
    aliases: ["סופרקריל לבן 18", "סופרקריל טמבור", "סופרקריל 18 ליטר", "צבע סופרקריל", "טמבור לבן 18", "53009"]
  },
  {
    sku: "56201",
    officialName: "אקווניר לאמבט 5 ליטר נירלט",
    category: "צבעים וציפויים",
    defaultWarehouse: "סניף 1 התלמיד",
    requiresBelaDeposit: false,
    requiresPalletDeposit: false,
    aliases: ["אקווניר לאמבט", "אקווניר 5 ליטר", "אקווניר נירלט", "צבע לאמבטיה נירלט", "56201"]
  },
  {
    sku: "56013",
    officialName: "צבע סיד סינטטי לתקרות 18 ליטר",
    category: "צבעים וציפויים",
    defaultWarehouse: "סניף 1 התלמיד",
    requiresBelaDeposit: false,
    requiresPalletDeposit: false,
    aliases: ["סיד סינטטי", "סיד לתקרות", "סיד 18 ליטר", "צבע לתקרות סיד", "56013"]
  },
  {
    sku: "58053",
    officialName: "דלי צבע לבן 18 ליטר (ריק)",
    category: "ציוד וכלי עבודה",
    defaultWarehouse: "סניף 1 התלמיד",
    requiresBelaDeposit: false,
    requiresPalletDeposit: false,
    aliases: ["דלי צבע לבן 18", "דלי ריק 18 ליטר", "דלי לבן 18", "58053"]
  },
  {
    sku: "58044",
    officialName: "דלי עבודה שחור 10 ליטר",
    category: "ציוד וכלי עבודה",
    defaultWarehouse: "סניף 1 התלמיד",
    requiresBelaDeposit: false,
    requiresPalletDeposit: false,
    aliases: ["דלי עבודה שחור", "דלי שחור 10 ליטר", "דלי פלסטיק שחור", "דלי בנאים", "58044"]
  },
  {
    sku: "76011",
    officialName: "בידוד מינרלי 12 ק״ג 24 מ״ר",
    category: "בידוד וגבס",
    defaultWarehouse: "סניף 1 התלמיד",
    requiresBelaDeposit: false,
    requiresPalletDeposit: false,
    aliases: ["בידוד מינרלי 12 קג", "צמר זכוכית", "בידוד מינרלי 24 מר", "בידוד לגבס 12 קג", "76011"]
  },
  {
    sku: "76012",
    officialName: "בידוד צמר סלעים 24 ק״ג 12 מ״ר",
    category: "בידוד וגבס",
    defaultWarehouse: "סניף 1 התלמיד",
    requiresBelaDeposit: false,
    requiresPalletDeposit: false,
    aliases: ["צמר סלעים 24 קג", "בידוד צמר סלעים", "צמר סלעים 12 מר", "צמר סלעים לגבס", "76012"]
  },
  {
    sku: "24050",
    officialName: "גליל קרטון גלי מגן ריצוף 50 מ״ר (מק״ט 24050 / 72050)",
    category: "מיגון וכיסוי אתרים",
    defaultWarehouse: "סניף 1 התלמיד",
    requiresBelaDeposit: false,
    requiresPalletDeposit: false,
    aliases: ["קרטון גלי 50 מר", "מגן ריצוף", "גליל קרטון גלי", "קרטון להגנת ריצוף", "24050", "72050"]
  },
  {
    sku: "14290",
    officialName: "שפכטל יוניפלוט (UNIFLOTT) קנאוף 5 ק״ג",
    category: "שפכטלים וגמר גבס",
    defaultWarehouse: "סניף 1 התלמיד",
    requiresBelaDeposit: false,
    requiresPalletDeposit: false,
    aliases: ["יוניפלוט", "UNIFLOTT", "יוניפלוט 5 קג", "קנאוף יוניפלוט", "שפכטל יוניפלוט", "14290"]
  },
  {
    sku: "71793",
    officialName: "פיבה FIBAFUSE 76 מ.א. (מק״ט 71793 / 71799)",
    category: "סרטי שריון וגבס",
    defaultWarehouse: "סניף 1 התלמיד",
    requiresBelaDeposit: false,
    requiresPalletDeposit: false,
    aliases: ["פיבה פיוז", "FIBAFUSE", "סרט פיבה", "פיבהפיוז 76", "71793", "71799"]
  },
  {
    sku: "71720",
    officialName: "סרט פינה משתנה 30 מ.א. ריין",
    category: "סרטי שריון וגבס",
    defaultWarehouse: "סניף 1 התלמיד",
    requiresBelaDeposit: false,
    requiresPalletDeposit: false,
    aliases: ["סרט פינה משתנה", "פינה משתנה ריין", "פינה משתנה 30 מטר", "סרט פינה ריין", "71720"]
  },
  {
    sku: "6412010",
    officialName: "נייר לטש שחור 120 (10 מ.א.)",
    category: "ציוד וכלי עבודה",
    defaultWarehouse: "סניף 1 התלמיד",
    requiresBelaDeposit: false,
    requiresPalletDeposit: false,
    aliases: ["נייר לטש 120", "נייר זכוכית 120", "לטש שחור 120", "נייר שיוף 120", "6412010"]
  },
  {
    sku: "41993",
    officialName: "ספייסר לפילוס 3 מ״מ RLS (250 יח׳)",
    category: "פילוס וריצוף",
    defaultWarehouse: "סניף 1 התלמיד",
    requiresBelaDeposit: false,
    requiresPalletDeposit: false,
    aliases: ["ספייסר פילוס 3 ממ", "ספייסרים RLS", "קליפסים לפילוס 3 ממ", "ספייסר 3 ממ 250 יח", "41993"]
  },
  {
    sku: "41997",
    officialName: "קלין לספייסר פילוס (250 יח׳)",
    category: "פילוס וריצוף",
    defaultWarehouse: "סניף 1 התלמיד",
    requiresBelaDeposit: false,
    requiresPalletDeposit: false,
    aliases: ["קלין לספייסר", "קלינים לפילוס", "טריזים לפילוס", "קלין 250 יח", "41997"]
  },
  {
    sku: "76206",
    officialName: "בורג גבס 25 מ״מ 1000 יח׳ VERO",
    category: "ברגים ופרזול",
    defaultWarehouse: "סניף 1 התלמיד",
    requiresBelaDeposit: false,
    requiresPalletDeposit: false,
    aliases: ["בורג גבס 25", "בורג 25 גבס", "ברגי גבס 25 ממ", "בורג ורו 25", "76206"]
  },
  {
    sku: "76216",
    officialName: "בורג גבס 35 מ״מ 1000 יח׳ VERO",
    category: "ברגים ופרזול",
    defaultWarehouse: "סניף 1 התלמיד",
    requiresBelaDeposit: false,
    requiresPalletDeposit: false,
    aliases: ["בורג גבס 35", "בורג 35 גבס", "ברגי גבס 35 ממ", "בורג ורו 35", "76216"]
  },
  {
    sku: "76133",
    officialName: "בורג פחפח 13 מ״מ 1000 יח׳ VERO",
    category: "ברגים ופרזול",
    defaultWarehouse: "סניף 1 התלמיד",
    requiresBelaDeposit: false,
    requiresPalletDeposit: false,
    aliases: ["בורג פחפח 13", "פחפח 13 ממ", "ברגי פחפח", "בורג לפחפח 1000", "76133"]
  },
  {
    sku: "76193",
    officialName: "בורג עדש לדיבל 7 (500 יח׳)",
    category: "ברגים ופרזול",
    defaultWarehouse: "סניף 1 התלמיד",
    requiresBelaDeposit: false,
    requiresPalletDeposit: false,
    aliases: ["בורג עדש", "בורג לדיבל 7", "בורג ראש עדש", "עדש לדיבל 7", "76193"]
  },
  {
    sku: "720497",
    officialName: "דיבל 7 אדום (100 יח׳)",
    category: "ברגים ופרזול",
    defaultWarehouse: "סניף 1 התלמיד",
    requiresBelaDeposit: false,
    requiresPalletDeposit: false,
    aliases: ["דיבל 7 אדום", "דיבל 7", "דיבלים 7 אדום", "דיבל אדום 100", "720497"]
  },
  {
    sku: "76260",
    officialName: "ערכת דבש שלישייה 100 יח׳",
    category: "ברגים ופרזול",
    defaultWarehouse: "סניף 1 התלמיד",
    requiresBelaDeposit: false,
    requiresPalletDeposit: false,
    aliases: ["ערכת דבש", "ערכת דבש שלישיה", "דיבל דבש", "שלישיית דבש", "76260"]
  }
];
/**
...
export async function POST(req: Request) {
  try {
    ...
    if (timeInMinutes >= 6 * 60 + 30 && timeInMinutes < 9 * 60 + 30) {
      ...
      currentPhaseDescription = "13:30 - 18:00 (סגירת מעגל תעודות, סיכום מול ורד/גליה, לקראת 18:00 הפקת דוח סוף יום שיקוף פניות לקוחות ואספקות לקבוצה ולהנהלה): עזרי לו לעשות סדר, לסגור תעודות, ולהפיק את דוח סוף היום המחייב לפי המבנה המוגדר."
    } else {
      currentPhaseKey = "evening_build"
      currentPhaseDescription = "18:00 ואילך (חזרה לטייבה, זמן משפחה, מצב פיתוח, ארכיטקטורה וקוד): היי שותפה טכנית מלאה ברמת קוד, ארכיטקטורה ו-Clean Code של מערכת סידור ח.סבן חומרי בנין."
    }
...
rami_personal_dna: {
  ...
  dual_role: "סדרן עבודה ומנהל תפעול ראשי (ביום) + מהנדס מערכות ומפתח סידור ח.סבן חומרי בנין (בערב)",
  ...
  daily_rhythm: {
    ...
    afternoon_audit: "13:30 - 18:00: סגירת מעגל תעודות, סיכום מול ורד/גליה, הכנת סידור למחר, ולקראת 18:00 הפקת דוח סוף יום שיקוף פניות לקוחות ואספקות לקבוצת הלקוחות וההנהלה.",
    evening_build: "18:00 ואילך: חזרה לטייבה, זמן משפחה, ולאחר מכן מצב פיתוח, ארכיטקטורה וקוד."
  },
...
1. **זהות השותף שלך:**
   ראמי הוא מנהל התפעול של סבן והמפתח שלך. הוא מנהל צי נהגים, עשרות שיחות מקבלנים בו-זמנית, פריקות מנוף ואתגרי שטח, ובמקביל בונה את המערכת הטכנולוגית (סידור ח.סבן חומרי בנין).
...
### 🧱 מודול זיכרון קשיח: קטלוג מוצרים, מחירון סגירה וסדר ליקוט מבצעי (חובה ובלתי מתפשר):
בכל הפקת הצעת מחיר, קליטת הזמנה, הפקת תעודה, כרטיס סידור או מענה לקבלנים, נועה תזהה ותתמחר לפי הנתונים הבאים בלבד (חל איסור מוחלט לנחש מק"טים או להמציא מחירי נטו):

#### 1. קטלוג מוצרים ומחירון נטו מחייב:
##### א. מוצרי חצר ומגרש (מחסן 4 החרש — ליקוט: אורן)
- מק"ט 11511 | סומסום שק גדול (בלה ~700 ק"ג) | מחירון: 105.00 ₪ | מחיר נטו: 85.00-105.00 ₪
- מק"ט 11551 | טיט מוכן שק גדול (בלה ~700 ק"ג) | מחירון: 130.00 ₪ | מחיר נטו: 90.00-130.00 ₪
- מק"ט 11501 | חול שק גדול (בלה ~750 ק"ג) | מחירון: 95.00 ₪ | מחיר נטו: 80.00-85.00 ₪
- מק"ט 10002 | מלט אפור 25 ק"ג נשר (CEM II) | מחירון: 20.32-38.00 ₪ | מחיר נטו: 17.09-30.00 ₪
- מק"ט 76206 | בורג גבס 25 מ"מ 1000 יח' VERO | מחירון: 59.32 ₪ | מחיר נטו: 47.46-50.00 ₪
- מק"ט 76216 | בורג גבס 35 מ"מ 1000 יח' VERO | מחירון: 91.10 ₪ | מחיר נטו: 72.88 ₪
- מק"ט 76133 | בורג פחפח 13 מ"מ 1000 יח' VERO | מחירון: 86.86 ₪ | מחיר נטו: 65.00-69.49 ₪
- מק"ט 76193 | בורג עדש לדיבל 7 (500 יח') | מחירון: 55.08 ₪ | מחיר נטו: 44.06 ₪
- מק"ט 720497 | דיבל 7 אדום (100 יח') | מחירון: 6.98 ₪ | מחיר נטו: 5.93 ₪
- מק"ט 76260 | ערכת דבש שלישייה 100 יח' | מחירון: 48.73 ₪ | מחיר נטו: 38.98 ₪

#### 2. מחירי פקדונות והובלה קבועים:
- מק"ט 60002 | שק גדול פקדון (בלה): 25.00 ₪ + מע"מ (חיוב 1:1 לכל בלת אגרגטים).
- מק"ט 60060 | משטח סבן פקדון: 40.00 ₪ + מע"מ (חיוב משטח מ-40 שקי מלט/דבק).
- מק"ט 18050 | הובלת מנוף הוד השרון: 300.00-350.00 ₪ + מע"מ לנסיעה.
- מק"ט 818050 | הובלה ללא פריקה הוד השרון: 200.00 ₪ + מע"מ (פטור מפקדונות בלות ומשטחים).

#### 3. סדר ליקוט מבצעי קבוע (מעלה-מטה):
בכל הפקת מסמך אספקה, תעודת ליקוט או סידור עבודה:
1. **חצר (אורן):** בלות אגרגטים כבדות ⬅️ משטחי שקים (מלט/דבק) ⬅️ לוחות גבס ופרופילים.
2. **חנות/דלפק (שי):** פחי צבע ודליים ⬅️ בידוד, קרטון ושפכטלים ⬅️ מערכות פילוס ⬅️ ברגים ודיבלים.
...
### 🌆 מודול משימת סוף יום: שיקוף פניות לקוחות ואספקות (לקראת 18:00):
- **ייעוד:** שיקוף תפעולי מלא, שקוף ומדויק לקבוצת הלקוחות וההנהלה של "ח. סבן חומרי בניין (1994) בע"מ".
- **תזמון:** מדי יום עבודה (א'–ה') לקראת השעה 18:00 (או בכל עת שראמי מבקש סיכום יום / דוח סוף יום).
- **מבנה הדוח המחייב:**
  1. *שורת פתיחה ומדד כללי:* סך פניות שנקלטו ואחוז ביצוע יומי (לדוגמה: "ערב טוב לכולם 🌆 | להלן סיכום סוף יום פעילות — שיקוף פניות לקוחות וביצועי אספקה (ח. סבן חומרי בניין):").
  2. *מה טופל וסופק במלואו (✅):* פירוט לקוחות, אתרים ומשאיות שפרקו בשטח (חלוקות גבס עלי, סבבי מנוף חכמת).
  3. *מה לא סופק / נדחה למועד אחר (🔄 / ⏳):* שיקוף מלא של כל הזמנה שטרם סופקה, סיבת הדחייה (תיאום לקוח, חוסר גישה, העברה לסבב בוקר), מועד אספקה חדש ונהג משויך.
  4. *בקרת איכות ותקלות ליקוט (⚠️):* ציון פערים או השלמות הנמצאים בבדיקה מול מנהלי המחסנים (אורן בחצר / תמיר ושמעון בתלמיד) עם התחייבות למועד השלמה.
  5. *חתימה קבועה ומחייבת:*
     *תודה לכל הצוות על יום פורה,*
     *ראמי ונועה ❤️ | מערך הסידור והתפעול*
...
זיהיתי עומס רגעי בענן המודלים של גוגל. כל נתוני ההזמנות, המשאיות והמק"טים שמורים במערכת סידור ח.סבן חומרי בנין.
