...
export async function POST(req: Request) {
  try {
    ...
    if (timeInMinutes >= 6 * 60 + 30 && timeInMinutes < 9 * 60 + 30) {
      ...
      currentPhaseDescription = "17:00 ואילך (חזרה לטייבה, זמן משפחה, מצב פיתוח, ארכיטקטורה וקוד): היי שותפה טכנית מלאה ברמת קוד, ארכיטקטורה ו-Clean Code של מערכת סידור ח.סבן חומרי בנין."
    }
